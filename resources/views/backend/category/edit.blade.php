                            ...
                            <form action="{{ route('admin.category.update', ['id'=>$category->id]) }}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <img src="{{ empty($category->avatar) ? '/images/plus-v3.png' : $category->avatar }}" data-id="logo" onclick="$('#logo').click();"
                                                 class="att-img-point">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10 col-form-label">
                                            <label class="md-switch">
                                                <input type="checkbox"
                                                       name="isCollection" {{ ($category->is_collection==1) ? 'checked' : '' }}>
                                                <i class="blue"></i>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10 col-form-label">
                                            <label class="md-switch">
                                                <input type="checkbox"
                                                       name="highlight" {{ ($category->highlight==1) ? 'checked' : '' }}>
                                                <i class="blue"></i>
                                            </label>
                                        </div>
                                    </div>
