...
@section('title') Chỉnh sửa vai trò @endsection
@section('content')
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group row">
                      ...
                      <div class="col-4">
                        <input type="text" value="{{ $role->name }}" name="name" class="form-control form-control-sm">
                        @error('name')
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-8 col-form-label">
                        <label class="md-switch"><input type="checkbox" {{ ($role->active==1) ? 'checked' : '' }} name="active"> <i class="green"></i></label> Hoạt động
                        @error('active')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
