...
$folderUpload = "E:/PhanMem/Xampp/htdocs/att/public/uploads/blogs/";
// Image upload
if($type == 'image'){
    ...
    if(in_array(strtolower($file_extension),$allowed_extension)){
        ...
        if(move_uploaded_file($_FILES['upload']['tmp_name'], $folderUpload.$_FILES['upload']['name'])){
            ...
            $url = $protocol."://".$_SERVER['SERVER_NAME'] ."/uploads/blogs/".$_FILES['upload']['name'];
...
if($type == 'file'){
    ...
    if(in_array(strtolower($file_extension),$allowed_extension)){
        ...
        if(move_uploaded_file($_FILES['upload']['tmp_name'], "/uploads/".$_FILES['upload']['name'])){
            ...
            $url = $protocol."://".$_SERVER['SERVER_NAME'] ."/uploads/".$_FILES['upload']['name'];
